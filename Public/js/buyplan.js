...
const stripe = Stripe(
  "pk_test_51JTXZaSA7ZYmi6JqdsozxeuESxHhcs6S3xsBxNkR7uBAWKWdcm8rsYPPcmQKLJ43JivlknA5MDkpprkItFzS1Flt002G4BIlfk"
);
    ...
    if (allLis.length < 6) {
      ...
      try {
        ...
        let session = await axios.post(
          "https://food-thekaaa-caf41b057aaf.herokuapp.com/api/plans/booking/createpaymentsession",
          { planId: planId }
        );
